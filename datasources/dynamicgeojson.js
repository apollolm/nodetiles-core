...
DynamicGeoJsonSource.prototype = {
    constructor: DynamicGeoJsonSource,
  ...
  load: function(callback) {
    ...
    if (!this._loading) {
      ...
      this._data = this._geoJSONObject;
...
module.exports = DynamicGeoJsonSource;
